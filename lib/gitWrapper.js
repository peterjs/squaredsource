...
//    while (callbacksCount < 1) {
//
//    }
//    console.log('callbacksCount ' + callbacksCount + ' gitExeFilenameArray.length ' + gitExeFilenameArray.length);
//    console.log('________val ' + gitExeFilename);
//    if (!gitExeFilename) throw "No suitable git version found";

////            filter(checkVersion).map(function(ver) {return {executable:ex, version:ver}});
